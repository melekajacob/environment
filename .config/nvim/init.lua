...
vim.keymap.set('n', '<leader>x', '<cmd>close<CR>', { desc = 'Split vertically' })
vim.keymap.set('n', '<leader>n', '<cmd>vertical new<CR>', { desc = 'New window (vertically)' })
...
--  similar to event listener in javascript
